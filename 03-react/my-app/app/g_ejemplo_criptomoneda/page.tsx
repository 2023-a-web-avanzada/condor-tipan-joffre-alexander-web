'use client'
import {ConsultaMoneda} from "@/app/g_ejemplo_criptomoneda/interfaces/ConsultaMoneda";
            ...
            <div className="col-sm-6">
                {
                    ...
                    <div>
                        ...
                        <p><strong>Precio mas alto del día:</strong>
                            {resultado.HIGHDAY}
                        </p>
                        <p><strong>Preciop mas bajo del día:</strong>
                            {resultado.LOWDAY}
                        </p>
                        <p><strong>Variación ultimas 24 horas:</strong>
